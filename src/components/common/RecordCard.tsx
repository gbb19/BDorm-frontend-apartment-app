  ...
  return (
    <View style={styles.card}>
      <View style={styles.roomHeader}>
        <Text style={styles.roomTitle}>Room: {ledgerItem.ledgerItemRoomNumber}</Text>
      ...
      <View style={styles.readingContainer}>
        <View style={styles.meterGrid}>
          ...
          <View style={styles.meterItem}>
            ...
            <View style={styles.meterValues}>
              <Text style={styles.currentValue}>{ledgerItem.electricityUnit}</Text>
            </View>
          </View>
        </View>
        {ledgerItem.ledgerItemStatus == 0 && (
          <View style={styles.actionButtons}>
            ...
            {((user.roles.includes("cashier") ||
              user.roles.includes("manager")) && ledgerItem.contract.username !== "") && (
              <TouchableOpacity
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalSubtitle}>
              ...
              {ledgerItem.ledgerMonth}/{ledgerItem.ledgerYear}
            </Text>
